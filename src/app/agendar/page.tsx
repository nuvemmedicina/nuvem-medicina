    ...
    <div className="min-h-screen pt-[76px]">
      ...
      >
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto px-8">
          ...
          <p className="text-[1rem] font-light text-muted mt-4 max-w-md mx-auto leading-relaxed">
      ...
      <div className="py-20 bg-white">
        <div className="max-w-[1240px] mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-[0.97rem] font-light text-muted leading-relaxed mb-10">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={label} className="flex gap-3.5 items-start p-4 bg-cloud border border-teal/10 rounded-2xl shadow-sm hover:border-teal/25 transition-colors">
                  <div className="w-10 h-10 rounded-lg bg-teal/5 flex items-center justify-center text-teal-light shrink-0">
                    <Icon className="w-[18px] h-[18px]" />
                  </div>
                  <div>
                    <strong className="block text-[0.72rem] font-semibold uppercase tracking-[.06em] text-faint mb-1">{label}</strong>
                    {values.map((v, i) => (
                      <a key={v} href={href[i]} className="block text-[0.93rem] text-steel hover:text-gold transition-colors">{v}</a>
                    ))}
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white border border-teal/10 rounded-2xl shadow-sm p-10">
            ...
            <p className="text-[0.9rem] text-muted mb-8">Nossa equipe entrará em contato em até 24h.</p>
            <AgendarForm />
          </div>
