        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="space-y-5 reveal">
            ...
            <div className="relative">
              <div
                className="w-full aspect-square max-w-[280px] mx-auto rounded-2xl overflow-hidden border-2 border-gold/30 flex items-center justify-center"
                style={{ background: 'linear-gradient(135deg, #071520, #00293A)' }}
              >
                {/* Placeholder — substituir por <Image src="/images/dra-vera.jpg" ... /> quando tiver a foto */}
                <div className="text-center">
                  <div
                    className="w-24 h-24 rounded-full mx-auto mb-4 flex items-center justify-center text-4xl font-bold border-2 border-gold/40"
                    style={{ background: 'rgba(201,168,76,0.15)', color: '#C9A84C' }}
                  >
                    VA
                  </div>
                  <p className="text-[0.75rem] text-faint">Foto em breve</p>
                </div>
              </div>
              {/* Gold line */}
            ...
            <div className="bg-ink border border-teal-light/[0.08] rounded-xl p-6 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2 border-t border-teal-light/[0.08]">
                ...
                <div>
                  ...
                  <p className="text-[0.65rem] text-faint">Diretora Técnica Certificada</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="reveal reveal-d1">
              ...
              <h2 className="sec-title mt-2 mb-5">
                Referência nacional em <em>motilidade digestiva</em>
              </h2>
