...
// Mapeia o locale do next-intl para o formato esperado pelo OpenGraph.
...
export async function generateMetadata({
  ...
  const ogLocale = OG_LOCALE[locale as AppLocale] ?? OG_LOCALE['pt-BR']
...
export default async function LocaleLayout({
  ...
  // Habilita renderização estática das páginas sob este layout (next-intl).
  setRequestLocale(locale)

  return (
    <html lang={locale} className={`${poppins.variable} ${cormorant.variable}`}>
      <head>
