...
const SECTIONS = [
  ...
  { titulo: '7. Cookies e tecnologias de rastreamento', texto: ['Nosso site utiliza cookies para melhorar sua experiência de navegação. Os cookies podem ser:', '• Essenciais: necessários para o funcionamento básico do site. Não podem ser desativados.', '• Analíticos: para entender como os visitantes utilizam o site (Google Analytics).', '• Publicitários: para medir o resultado de nossas campanhas (Google Ads). Não são vinculados a dados de saúde.', 'Cookies analíticos e publicitários só são ativados após o seu consentimento, dado no banner exibido na primeira visita. Você pode alterar sua escolha a qualquer momento pelo link "Preferências de Cookies" no rodapé do site, ou desativar os cookies diretamente nas configurações do seu navegador.'] },
